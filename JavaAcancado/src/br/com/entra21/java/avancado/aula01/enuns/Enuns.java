...
public class Enuns {
	...
	static public enum Personagens {
		...
		BARBARO("Muita resistência física"), 
		GUERREIRO("Muito dano físico"), 
		ARQUEIRO("Dano físico a distância"),
		MAGO("Ataque mágico supremo a distância");
	...
	static public enum VideoGames {
		...
		XBOX_S("Irmão menor do XBOX-S", 2800.50), 
		XBOX_X("Console mais recente do XBOX", 4200.5),
		PS4("Versão para comprar agora", 3000.5), 
		PS5("Console mais caro no momento", 6000.5);
	...
	private static void aprenderDentroClasse() {
		...
		System.out.println("-----------------------------");
		System.out.println("OUTRO EXEMPLO DE ENUM");
		System.out.println("-----------------------------");
